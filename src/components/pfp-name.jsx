...
export default function PfpName(usrName) {
  ...
  return (
    <div className="flex gap-2" onClick={displayMenuList}>
      ...
      <div className="user-name text-[rgb(91,131,154)] font-bold flex h-[1.5vw] w-[6vw] self-center text-xl">
        ...
        <i className="ri-arrow-drop-down-line text-[1.5vw] h-[1vw] relative"></i>
        <i className="ri-arrow-drop-up-line text-[1.5vw] h-[1vw] relative hidden"></i>
      </div>
    </div>
  );
}